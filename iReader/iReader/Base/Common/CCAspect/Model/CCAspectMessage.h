...
@class CCAspectArgument;

NS_ASSUME_NONNULL_BEGIN

@interface CCAspectMessage : NSObject
...
/*
 消息类型，默认：CCAspectMessageTypeDefault
 
//======CCAspectMessageTypeReturn======//
 ...
 // JSON: return=CCArgumentType:value
 "message" : "return=3:1"

 
//======CCAspectMessageTypeAssign======//
 ...
 // JSON: instanceName=CCArgumentType:value
 "message":"a=3:1"
 
 **/
@property (nonatomic, assign) CCAspectMessageType messageType;
...
/// 参数 Model 缓存
@property (nonatomic, strong) NSMutableDictionary<NSString *, NSArray<CCAspectArgument *> *> *aspectArgumentParameters;
